...
import { Shirt, Flag as FansGear, Tv, Trophy, Flag, Timer, Sparkles, Calendar } from 'lucide-react';
...
const CategorySidebar = ({ selectedCategory, onCategoryChange }: CategorySidebarProps) => {
  ...
  return (
    ...
    >
      ...
      {/* World Cup 2026 Banner with Schedule Link */}
      <div 
        className="mt-4 p-3 bg-gradient-to-br from-gold/10 to-gold/5 rounded-lg border border-gold/20 cursor-pointer hover:border-gold/40 transition-colors"
      ...
      >
        <div className="text-center">
          ...
          <Button
            variant="ghost"
            size="sm"
            className="mt-2 w-full text-xs text-gold hover:text-gold-light hover:bg-gold/10"
          >
